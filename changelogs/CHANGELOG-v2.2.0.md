# Wan2GP Desktop Launcher v2.2.0
...
> This release supersedes the abandoned v2.1.9 build. The v2.1.9 tag on GitHub (External
> Terminal mode) was a pre-release; all v2.1.9 features are included here.
...
- **Launch in External Terminal** (carried forward from v2.1.9) — a third launch mode that
  runs the server in a genuine Windows Terminal / conhost cmd window with env activation,
  your port, and Manage-menu args, plus an in-app Stop that kills it by PID.
...
- **Stale release version** — `package.json` `release:win` script updated from 2.1.5 → 2.2.0.

## v2.1.9 fixes carried forward

- Launch in External Terminal mode
