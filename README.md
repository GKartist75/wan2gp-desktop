...
> New in v2.1.5: System tray integration (minimize-to-tray with context menu), window state persistence, auto-start with Windows, follow system theme, desktop notifications when server is ready/stops, and an F12 popup picker to choose between inspecting embedded Wan2GP content or the Electron shell. See changelog.
