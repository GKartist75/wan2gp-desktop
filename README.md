...
> ## ⚠️ This Electron edition is retired — switch to Tauri
>
> **We recommend [Wan2GP Desktop Launcher Tauri](https://github.com/GKartist75/Wan2GP-Desktop-Tauri)** — same launcher, same Wan2GP, same features. It uses the WebView2 engine already in Windows plus a compiled Rust backend: **~3 MB installer instead of ~150 MB**, faster startup, lower RAM, and it's the only edition still maintained.
>
> **Switching is painless:** download the [Tauri release](https://github.com/GKartist75/Wan2GP-Desktop-Tauri/releases/latest), install & launch it — it detects this Electron app and offers to remove it. Your Wan2GP install, models and settings carry over untouched.
>
